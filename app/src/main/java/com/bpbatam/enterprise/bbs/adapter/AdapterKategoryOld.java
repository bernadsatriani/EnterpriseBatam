 ...
 */
public class AdapterKategoryOld extends  RecyclerView.Adapter<AdapterKategoryOld.ViewHolder>{

    private ArrayList<ListData> mCourseArrayList;
    private Context context;

    public AdapterKategoryOld(Context context, ArrayList<ListData> mCourseArrayList, OnDownloadClicked listener) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder
        ...
        public ViewHolder(View itemView,
                          ...
                          final AdapterKategoryOld mCourseAdapter) {
            super(itemView);
