...
import com.bpbatam.enterprise.persuratan.adapter.ViewPagerAdapterPersuratanDetail;

/**
 * Created by User on 10/1/2016.
 */
public class persuratan_detail extends AppCompatActivity {

    CharSequence Titles[]={"Dokumen","Tertanda", "Distribusi"};
    int Numboftabs =3;

    ViewPager pager;
    ViewPagerAdapterPersuratanDetail adapter;
    TabLayout tabs;
    ...
    void InitControl(){
        ...
        adapter =  new ViewPagerAdapterPersuratanDetail(getSupportFragmentManager(),Titles,Numboftabs);
