 ...
 */
public class persuratan_status_surat extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.menu_persuratan_pilih_status_surat);
        InitControl();
