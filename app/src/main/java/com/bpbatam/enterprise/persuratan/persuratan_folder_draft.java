 ...
 */
public class persuratan_folder_draft extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.menu_persuratan_pilih_draft);
        InitControl();
