 ...
 */
public class ViewPagerAdapterPersuratanPermohonan extends FragmentStatePagerAdapter {
    ...
    public ViewPagerAdapterPersuratanPermohonan(FragmentManager fm, CharSequence mTitles[], int mNumbOfTabsumb) {
        super(fm);
